...
@return */
func (a *RepotokenApiService) ChangeToken(ctx context.Context, code string, repository string, body TokenPermission) (*http.Response, error) {
	var (
...
@param body Request body contents.
@return */
func (a *RepotokenApiService) CreateToken(ctx context.Context, repository string, body NewToken) (*http.Response, error) {
	var (
